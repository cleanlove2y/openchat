...
export function Chat({
  ...
  return (
    <>
      <div className="overscroll-behavior-contain flex min-h-0 min-w-0 flex-1 touch-pan-y flex-col bg-background">
        <ChatHeader
          chatId={id}
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {process.env.NODE_ENV === "production"
                ? t("gateway.descriptionOwner")
                : t("gateway.descriptionYou")}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => {
                ...
                window.location.href = localizePathFromPathname(pathname, "/");
              }}
            >
              {t("gateway.activate")}
            </AlertDialogAction>
